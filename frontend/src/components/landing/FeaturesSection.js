...
import { ApartmentOutlined, AuditOutlined, DollarOutlined, SafetyCertificateOutlined, TeamOutlined, ToolOutlined } from '@ant-design/icons';
...
const features = [
  ...
  { title: 'Access and Role', text: 'Admin-first role-based access with room for developer and designer roles.', icon: <SafetyCertificateOutlined /> },
  ...
  return (
    <section id="features" className="section">
      <div className="section-header">
        ...
        <p className="section-text">A structured dashboard for projects, clients, teams, invoices, access, services, settings, and support.</p>
      </div>
